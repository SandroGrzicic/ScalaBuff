...
class Generator protected(sourceName: String) {
	...
	/**
	 * Whether to optimize the generated class for speed (true) or for code size (false). True by default.
	 */
	...
	protected def generate(tree: List[Node]) = {
		...
		// traverse the tree here, so we can get class/package names, options, etc.
...
object Generator {
	 ...
	 * @param tree parse tree, as generated by Parser.
	 */
